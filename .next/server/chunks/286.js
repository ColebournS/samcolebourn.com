...
const Header = ({ handleAboutScroll , handleWorkScroll , handleContactScroll , isBlog ,  })=>{
    ...
    const { 0: scrolled , 1: setScrolled  } = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false);
    const handleScroll = ()=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                className: `mt-10 hidden flex-row items-center justify-between sticky ${scrolled && theme === "dark" ? "bg-[#121212] rounded-lg" : scrolled && theme === "light" ? "bg-white" : "bg-transparent"} light:text-black top-0 z-10 tablet:flex`,
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                        onClick: ()=>router.push("/")
                        ,
...
const socialData_namespaceObject = JSON.parse('{"U":[{"id":"1","title":"LinkedIn","link":"https://www.linkedin.com/in/sam-colebourn/"},{"id":"2","title":"Github","link":"https://github.com/ColebournS"},{"id":"5","title":"Email","link":"mailto:sam.colebourn@gmail.com"}]}');
